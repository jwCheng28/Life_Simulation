...
export class Universe {
    ...
    */
    random_initialization(population) {
        wasm.universe_random_initialization(this.ptr, population);
    }
    /**
    * @param {Uint8Array} new_cell
    */
    set_cells(new_cell) {
        var ptr0 = passArray8ToWasm0(new_cell, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.universe_set_cells(this.ptr, ptr0, len0);
    }
    /**
    * @returns {number}
    */
    cell_ptr() {
        var ret = wasm.universe_cell_ptr(this.ptr);
        return ret;
    }
    /**
    */
    next_cycle() {
        wasm.universe_next_cycle(this.ptr);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('life_simulation_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
