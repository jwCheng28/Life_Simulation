import init from '../pkg/life_simulation.js';
// import { memory } from '../pkg/life_simulation_bg.wasm';
...
export const drawCells = (ctx, universe, width, height, cell) => {
    ...
    */
    const cells_arr = new Uint8Array(wasm.memory.buffer, universe.cell_ptr(), width*height);
    let cur = 0;
    ctx.beginPath();
    for (let i = 0; i < height; ++i) {
        for (let j = 0; j < width; ++j) {
